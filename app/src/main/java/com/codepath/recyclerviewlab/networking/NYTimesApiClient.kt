...
class NYTimesApiClient {
     ...
     * @param pageNumber
     */
    private fun getArticlesByQuery(articlesListResponse: CallbackResponse<List<Article?>?>, query: String?, pageNumber: Int) {
    ...
    companion object {
        ...
        private const val API_KEY = "3NFuNSxGEX2UX8AUpQtDJXkaOGklqSLi"
